...
class Ui_AutoSubtitle(object):
    def setupUi(self, AutoSubtitle):
        ...
        self.VideoPathEdit.editingFinished.connect(AutoSubtitle.updateOpenPath) # type: ignore
    ...
    def retranslateUi(self, AutoSubtitle):
        ...
        self.Title.setText(_translate("AutoSubtitle", "<html><head/><body><p>自动打轴机<span style=\" color:#353535;\"> v2.0.0</span></p></body></html>"))
