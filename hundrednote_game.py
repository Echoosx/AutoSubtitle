...
import numpy as np
import configparser
from config import HN_gameStylePath, globalConfigPath, styleSheetPath

stylecode = open(HN_gameStylePath, 'r', encoding="utf-8").read()
...
def autosub(videopath, subpath):
    ...
    if isOpened:
        ...
        while True:
            ...
            current_pic = frame[840:910, 150:350]
